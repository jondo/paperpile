...
XmlOutputDev::XmlOutputDev(GString *fileName, GString *fileNamePdf,GString *title, GBool physLayoutA,
  ...
  xmlNodePtr nodeTitle = xmlNewNode(NULL,(const xmlChar*)TAG_TITLE);
  nodeTitle->type = XML_ELEMENT_NODE;
  xmlAddChild(nodeProcess,nodeTitle);
  xmlNewProp(nodeTitle,(const xmlChar*)ATTR_VALUE,(const xmlChar*)title->getCString());	
