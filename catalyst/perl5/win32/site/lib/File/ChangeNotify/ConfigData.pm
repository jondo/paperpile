package File::ChangeNotify::ConfigData;
use strict;
...
This module holds the configuration data for the C<File::ChangeNotify>
module.  It also provides a programmatic interface for getting or
setting that configuration data.  Note that in order to actually make
changes, you'll have to have write access to the C<File::ChangeNotify::ConfigData>
...
C<File::ChangeNotify::ConfigData>, or in scalar context the number of items.

=item feature_names()

Returns a list of all the names of features currently defined in
C<File::ChangeNotify::ConfigData>, or in scalar context the number of features.
...
Requires write access to the C<File::ChangeNotify::ConfigData> module.
...
C<File::ChangeNotify::ConfigData> was automatically created using C<Module::Build>.
C<Module::Build> was written by Ken Williams, but he holds no
authorship claim or copyright claim to the contents of C<File::ChangeNotify::ConfigData>.
