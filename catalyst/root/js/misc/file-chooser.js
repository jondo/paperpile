Paperpile.FileChooser = Ext.extend(Ext.Window, {
    ...
    initComponent: function() {
        ...
        this.items.get('northpanel').on('afterLayout', function() {
            this.showDir(this.currentRoot);
        },
        this, {
            single: true
        ...
        this.textfield.on('change', function(field, newValue, oldValue) {
            ...
            Ext.Ajax.request({
                ...
                success: function(response) {
                    ...
                    if (json.stats.exists) {
                        Ext.Msg.confirm('', path + ' already exists. Overwrite?', function(btn) {
                            if (btn == 'yes') {
    ...
    showDir: function(path) {
        ...
        treepanel.on("fileaction", function(e, el, options) {
        ...
        for (var i = 0; i < path.length; i++) {
            ...
            Ext.Element.get(li).on('click', function(e, el, options) {
