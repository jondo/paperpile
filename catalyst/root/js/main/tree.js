...
Ext.extend(Paperpile.Tree, Ext.tree.TreePanel, {
    initComponent: function() {
        ...
        this.getSelectionModel().on("beforeselect", function() {
    ...
    configureSubtree: function(node) {
        ...
        var ok = Ext.DomHelper.append(div, '<a href="#" id="configure-node" class="pp-textlink">Done</a>', true);
...
Paperpile.Tree.FolderMenu = Ext.extend(Paperpile.Tree.ContextMenu, {
    ...
    getShownItems: function(node) {
        if (node.id == 'FOLDER_ROOT') {
            return['folder_menu_new', 'folder_menu_export'];
        } else {
            return['folder_menu_new', 'folder_menu_delete', 'folder_menu_rename', 'folder_menu_export'];
        }
    }
...
Paperpile.Tree.ActiveMenu = Ext.extend(Paperpile.Tree.ContextMenu, {
    ...
    getShownItems: function(node) {
        if (node.id == 'ACTIVE_ROOT') {
            return['active_menu_rss', ];
        } else {
            return['active_menu_delete', 'active_menu_rename', 'active_menu_export'];
        }
    }
});
...
Paperpile.Tree.TagsMenu = Ext.extend(Paperpile.Tree.ContextMenu, {
    ...
    getShownItems: function(node) {
        if (node.id == 'TAGS_ROOT') {
            ...
            return['tags_menu_new', 'tags_menu_delete', 'tags_menu_rename', 'tags_menu_style', 'tags_menu_export'];
        }
    }
});
