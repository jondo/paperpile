Paperpile.QueueWidget = Ext.extend(Ext.BoxComponent, {
    ...
    initComponent: function() {
        ...
        var t = new Ext.XTemplate('<div id="queue-widget-button" class="pp-queue-widget-container">', '  <div class="pp-queue-widget-content">', '    <tpl if="submitting">', '      <span class="pp-queue-widget-item"> Starting background tasks </span>', '    </tpl>', '    <tpl if="clearing">', '      <span class="pp-queue-widget-item"> Clear background tasks </span>', '    </tpl>', '    <tpl if="!submitting && !clearing">', '      <tpl if="num_pending==1">', '        <span class="pp-queue-widget-item"> {num_pending} task remaining</span>', '      </tpl>', '      <tpl if="num_pending &gt;1">', '        <span class="pp-queue-widget-item"> {num_pending} tasks remaining</span>', '      </tpl>', '      <tpl if="!num_pending">', '        <span class="pp-queue-widget-item"> All tasks done. ', '        <tpl if="num_error">{num_error} failed.</tpl>', '        </span>', '      </tpl>', '     <span class="pp-queue-widget-item"><a href="#" class="pp-textlink pp-queue-widget-action" action="queue-tab">Show</a></span>', '     <tpl if="!num_pending">', '        <span class="pp-queue-widget-item"><a href="#" class="pp-textlink pp-queue-widget-action" action="queue-clear">Clear</a></span>', '     </tpl>', '   </tpl>', '  </div', '</div>').compile();
