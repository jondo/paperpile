Paperpile.QueueControl = Ext.extend(Ext.Panel, {
    ...
    markup: ['<div class="pp-box pp-box-style1" style="height:200px;"', '<h2>Progress</h2>', '<p id="queue-progress"></p>', '<div id="queue-status"></div>', '<table style="border: 2px; margin: 10px auto;"><tr>', '<td style="padding: 0 10px;"><div id="pause-button"></div></td>', '<td style="padding: 0 10px;"><div id="cancel-button"></div></td>', '</tr></table>', '</div>', ],

    markupProgress: ['<p></p>', '<tpl if="eta"><p>About {eta} left.</p></tpl>', ],

    markupDone: ['<p>All tasks completed</p>', ],
