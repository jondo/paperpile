...
Ext.Element.addMethods(function() {
    ...
    return {
        ...
        anim: function(args, opt, animType, defaultDur, defaultEase, cb) {
            ...
            me.dom, args, (opt.duration || defaultDur) || .35, (opt.easing || defaultEase) || 'easeOut', function() {
                if (cb) cb.call(me);
...
(function() {
    ...
    Ext.Fx = {
        ...
        fxanim: function(args, opt, animType, defaultDur, defaultEase, cb) {
            ...
            this.dom, args, (opt.duration || defaultDur) || .35, (opt.easing || defaultEase) || EASEOUT, cb, this);
            opt.anim = anim;
            return anim;
        }
    };
