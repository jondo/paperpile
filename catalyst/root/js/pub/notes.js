Paperpile.PubNotes = Ext.extend(Ext.Panel, {
    markup: ['<tpl if="annote">', '<div class="pp-action pp-action-edit-notes">', '<a href="#" class="pp-textlink" id="edit-notes-{id}">Edit Notes</a>', '</div>', '<div class="pp-notes">{annote}</div>', '</tpl>', '<tpl if="!annote">', '<div class="pp-action-big pp-action-add-notes" id="add-notes-{id}">', '<a href="#" class="pp-textlink">Add notes</a>', '</div>', '</tpl>'],
