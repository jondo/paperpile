Ext.define('Paperpile.pub.panel.Files', {
  ...
  getAttachmentsSection: function(data) {
    var el = [
      ...
      '              {[Paperpile.pub.PubPanel.actionTextLink("DELETE_FILE",values.guid)]}',
      '              {[Paperpile.pub.PubPanel.actionTextLink("RENAME_FILE",values.guid)]}',
      '          </tpl>',
      '       </ul>',
      '    </tpl>',
  ...
  getPdfSection: function() {
    ...
    var el = [
      ...
      '    {[Paperpile.pub.PubPanel.actionTextLink("OPEN_PDF_EXTERNAL")]}',
      '    {[Paperpile.pub.PubPanel.actionTextLink("OPEN_PDF_FOLDER")]}',
      '    {[Paperpile.pub.PubPanel.actionTextLink("DELETE_PDF",values.pdf)]}',
      '  </tpl>',
