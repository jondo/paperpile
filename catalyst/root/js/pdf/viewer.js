...
Paperpile.PDFviewer = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        this.tbItems['LAYOUT_MENU'] = new Ext.ux.AutoHideMenuButton({
            menu: {
                cls: 'no-icon-menu',
                items: [
                this.tbItems['ONE_UP'], this.tbItems['TWO_UP'], this.tbItems['FOUR_UP'], "-", this.tbItems['SINGLE'], this.tbItems['CONTINUOUS']]
            },
            icon: "/images/icons/continuous-pages.png",
            enableToggle: false
        });
        ...
        this.searchBar = new Ext.Window({
            ...
            unstyled: false,
            items: [
            this.tbItems['SR_PREV'], this.tbItems['SR_NEXT'], this.tbItems['SR_TEXT'], this.tbItems['SR_CLOSE']],
            cls: 'pdf-search'
        });
        ...
        this.tbItems['PAGE_PREV'], this.tbItems['PAGE_FIELD'], this.tbItems['PAGE_COUNT'], this.tbItems['PAGE_NEXT'], {
            xtype: 'tbseparator'
        },
        //      this.tbItems['LAYOUT_MENU'],
        this.tbItems['ZOOM_MENU'], this.tbItems['ZOOM_IN'], this.tbItems['ZOOM_OUT'], {
            xtype: 'tbseparator'
        },
    ...
    afterRender: function() {
        ...
        this.bbar.on('afterlayout', function(tb) {
...
*/
    ...
    searchMoveUpdate: function() {
        ...
        log("Search page scroll from:" + this.viewStartPage + " to: " + targetPage);
    ...
    loadSearchResultsIntoPage: function(pageIndex) {
        ...
        if (searchHolder != null) {
            var block = Ext.DomHelper.overwrite(searchHolder, hitDivs, true);
        }
    },
    ...
    select: function(pageIndex, x1, y1, x2, y2) {
        ...
        for (i = 0; i < lines.length; i++) {
            ...
            } else if (i > 0 && this.lineWithinRegion(lines[i - 1], x1, y1, x2, y2) && i < lines.length - 1 && this.lineWithinRegion(lines[i + 1], x1, y1, x2, y2)) {
                selectedLines.push({
                    x1: line.x1,
                    y1: line.y1,
                    x2: line.x2,
...
*/
    ...
    onMouseMove: function(e) {
        ...
        if (this.toolMode == 'select') {
            if (this.isMouseDown) {
                ...
                var args = [pageIndex, pageDX, pageDY, pageCX, pageCY];
    ...
    loadKeyEvents: function() {
        this.keys = new Ext.KeyMap(this.focusEl, [{
            key: [Ext.EventObject.LEFT, Ext.EventObject.RIGHT, Ext.EventObject.UP, Ext.EventObject.DOWN, Ext.EventObject.PAGE_UP, Ext.EventObject.PAGE_DOWN],
            fn: this.keyNav,
            scope: this
        },
        {
