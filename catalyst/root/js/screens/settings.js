Paperpile.GeneralSettings = Ext.extend(Ext.Panel, {
    ...
    setupFields: function() {
        ...
        Ext.get('settings-cancel-button').on('click', function() {
        ...
        Ext.each(['proxy', 'proxy_user', 'proxy_passwd'], function(item) {
        ...
        this.combos['pager_limit'].on('select', function() {
            this.isDirty = true;
            this.setSaveDisabled(false);
        },
        this);
        ...
        this.proxyCheckbox.on('check', function(box, checked) {
        ...
        this.proxyTestButton.on('click', function() {
...
Paperpile.PluginOrderPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        Ext.apply(this, {
            ...
            items: [
            this.usedPlugins, this.availablePlugins],
            height: 175,
    ...
    createPluginOrderTreePanel: function(config) {
        ...
        newPanel.getSelectionModel().on("beforeselect", function() {
            return false;
        });
