Paperpile.Updates = Ext.extend(Ext.Panel, {
    ...
    markupPatch: ['<div class="pp-box pp-box-top pp-box-style1" style="width:400px;">', '<tpl for="updates">', '<h2>Update {name}</h2>', '<p>{msg}</p>', '<ul class="pp-update-log">', '<tpl for="log">', '<li>{.}</li>', '</tpl>', '</ul>', '</tpl>', '<center><div id="download-button"></div></center>', '<p>&nbsp;</p>', '</div>', ],

    // Add details how to install updates for different operating systems
    markupNoPatch: ['<div class="pp-box pp-box-top pp-box-style1" style="width:400px;">', '<p>&nbsp;</p>', '<p>Version {latestVersion} of Paperpile is available for download</p>', '<center><div id="download-button"></div></center>', '<p>&nbsp;</p>', '</div>', ],
