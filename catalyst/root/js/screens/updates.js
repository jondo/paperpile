Paperpile.Updates = Ext.extend(Ext.Panel, {
    ...
    afterRender: function(){
        ...
        var b = new Ext.Button({ renderTo: 'download-button',
                                 text: buttonText,
                               });
    ...
    performUpgrade: function(){
        ...
        upgrader.setOnReadLine(function(line){
                      ...
                      callback: function(action){
                          if (action === 'ACTION1'){
                              ...
                              Ext.Msg.show({
                                  ...
                                  fn: function(btn){
                                      if (btn === 'ok'){
                                          Paperpile.main.reportError({msg:log.error});                                      
                                      }
            ...
            if (log.status === 'EXTRACT'){
                Ext.Msg.wait("", "Extracting updates", {interval: 100});
            }

            if (log.status === 'PATCH'){
                Ext.Msg.wait("", "Applying changes", {interval: 100});
            }
