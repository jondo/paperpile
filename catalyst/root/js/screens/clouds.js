Paperpile.Clouds = Ext.extend(Ext.Panel, {
    ...
    markup: ['<div style="padding: 5px;">', '  <div class="pp-box-tabs pp-box-tabs-left">', '   <ul id="stats-tabs">', '     <li class="pp-bullet pp-box-tabs-first pp-box-tabs-active" action="show_authors">Authors</li>', '     <li class="pp-bullet" action="show_journals">Journals</li>', '     <li class="pp-bullet" action="show_tags">Labels</li>', '     </li>', '   </ul>', '</div>',

    '<div id="pp-cloud-checkbox">', '<p>Sort By:</p>', '<ul id="stats-options" class="pp-cloud-options">', '  <li class="pp-cloud-options-active" ><a action="sort_alphabetical" href="#" class="pp-textlink">Alphabetical</a></li>', '  <li class="pp-cloud-options-active" ><a action="sort_count" href="#" class="pp-textlink">Paper Count</a></li>', '</ul>', '</div>',

    '<div class="pp-box-right">', '  <div class="pp-box pp-box-right pp-box-style1" style="padding:20px; min-height: 200px; min-width:600px; max-width:600px;">', '  <div class="pp-container-centered">', '    <div id="container" style="display: table-cell;vertical-align: middle;">', '      <div id="cloud"></div>', '    </div>', '    </div>', '    </div>', '  </div>', '</div>'],
