Paperpile.PatternSettings = Ext.extend(Ext.Panel, {
    ...
    setupFields: function() {
        ...
        Ext.get('patterns-cancel-button').on('click', function() {
            Paperpile.main.tabs.remove(Paperpile.main.tabs.getActiveTab(), true);
        });

        Ext.each(['library_db', 'paper_root', 'key_pattern', 'pdf_pattern', 'attachment_pattern'], function(item) {
    ...
    updateFields: function() {
        ...
        Ext.each(['library_db', 'paper_root', 'key_pattern', 'pdf_pattern', 'attachment_pattern'], function(key) {
