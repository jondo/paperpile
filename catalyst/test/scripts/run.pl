...
my %suites = (
  basic => {
    ...
    files => [ "t/basic.t", "t/formats/bibtex.t", "t/formats/ris.t", "t/formats/zotero.t", "t/formats/mendeley.t", "t/plugins/pubmed.t", "t/plugins/googlescholar.t", "t/plugins/duplicates.t" ]
  },
  cover => {
