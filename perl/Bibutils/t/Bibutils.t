...
## Note: we need to read again as we cannot write more than one time
## after one read. Strange things happen if you do this (e.g. LateX
## escape codes accumulate)

$bu->in_file('t/test.bib');
$bu->read;
my $string=undef;
$string = $bu->as_string;
ok( $string, 'Writing data to string' );
