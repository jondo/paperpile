...
sub _parse_freestyle_helper {
  ...
  my @prefixes = (
    'Op de', 'van der', 'von der', 'von zu', 'van de', 'van den', 'auf den', 'de la',
    'al',    'au',      'af',      'el',     'do',     'del',     'de las',  'della',
    'dello', 'des',     'di',      'de',     'da',     'dos',     'du',      'la',
    'le',    'lo',      'les',     'Mc',     'lou',    'pietro',  'st.',     'st',
    'ter',   'vanden',  'van',     'vel',    'ver',    'vere',    'vom',     'von',
    'zur',   'ten',     'te',      'den',    'sir'
  );
